angular.module('Statusengine')
    ...
    .controller("NodeChecksController", function ($http, $interval, $scope, ReloadService, $document, $stateParams, $state) {
        ...
        $scope.reload = function () {
            offset = 0;
            $http.get("/api/index.php/hostchecks", {
                params: {
