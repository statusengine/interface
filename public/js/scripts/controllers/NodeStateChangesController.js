angular.module('Statusengine')
    ...
    .controller("NodeStateChangesController", function ($http, $interval, $scope, ReloadService, $document, $stateParams, $state) {
        ...
        $scope.reload = function () {
            offset = 0;
            $http.get("/api/index.php/hoststatehistory", {
                params: {
