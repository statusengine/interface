angular.module('Statusengine')
    ...
    .controller("ServiceChecksController", function ($http, $interval, $scope, ReloadService, $document, $stateParams, $state) {
        ...
        $scope.reload = function () {
            offset = 0;
            $http.get("./api/index.php/servicechecks", {
                params: {
