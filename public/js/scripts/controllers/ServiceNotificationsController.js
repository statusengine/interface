angular.module('Statusengine')
    ...
    .controller("ServiceNotificationsController", function ($http, $interval, $scope, ReloadService, $document, $stateParams, $state) {
        ...
        $scope.reload = function () {
            offset = 0;
            $http.get("/api/index.php/servicenotifications", {
                params: {
        ...
        $document.on('scroll', function () {
            if(!$state.is('servicenotifications')){
                return;
            }
