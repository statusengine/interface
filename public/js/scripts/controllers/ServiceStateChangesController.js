angular.module('Statusengine')
    ...
    .controller("ServiceStateChangesController", function ($http, $interval, $scope, ReloadService, $document, $stateParams, $state) {
        ...
        $scope.reload = function () {
            offset = 0;
            $http.get("./api/index.php/servicestatehistory", {
                params: {
                    hostname: $scope.nodename,
                    service_description: $scope.servicedescription,
                    order: 'state_time',
                    direction: 'desc',
                    limit: limit,
                    offset: offset,
        ...
        $document.on('scroll', function () {
            if(!$state.is('servicestatechanges')){
                return;
            }
