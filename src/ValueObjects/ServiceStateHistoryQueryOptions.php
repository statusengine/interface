...
class ServiceStateHistoryQueryOptions extends QueryOptions {
    ...
    /**
     * ServiceStateHistoryQueryOptions constructor.
     * @param $params
     * @throws \Exception
     */
    public function __construct($params) {
        ...
        if (isset($this->params['service_description'])) {
            $this->service_description = $this->params['service_description'];
        }
